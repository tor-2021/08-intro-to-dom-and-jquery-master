...
Complete the [main.js](starter-code/js_dom_exercise/main.js) file in [js_dom_exercise](starter-code/js_dom_exercise) folder or use [this codesandbox starter code](https://codesandbox.io/s/jsd0309-dom-exercise-starter-ng9dn?file=/script.js):
...
[Codesandbox jQuery Code Along](https://codesandbox.io/s/jsd0309-jquery-code-along-vlk3k?file=/index.html)
...
Complete the [main.js](starter-code/jquery_exercise/main.js) app in the [jquery_exercise folder](starter-code/jquery_exercise) or [fork this codesandbox starter code link](https://codesandbox.io/s/jsd0309-jquery-exercise-starter-onh21?file=/script.js).
...
[Codesandbox Starter Code - please fork](https://codesandbox.io/s/jsd0309-99-bottles-jquery-hw-starter-kwb45)

- Remember the [99 Bottles of Coke assignment](https://git.generalassemb.ly/jsd030921/04-conditionals-and-loops/blob/master/README.md#homework)? For this assignment, you'll be creating a website that programatically displays the lyrics to that song.
